...
function GradientNumber({ value, size = 32, palette = "sage" as Palette }: { value: string | number; size?: number; palette?: Palette }) {
  const gradient =
    palette === "danger"
...
function VersionPicker({ versions, value, onChange, exclude }: VersionPickerProps) {
  return (
...
export function DiffView({ resumeId, versions }: DiffViewProps) {
